import { GameItem } from "@/stores/game.data.store";
...
interface PickProductProps {
  products: GameItem[]; // Define the expected prop type
}

export default function PickProduct({ products }: PickProductProps) {
  return (
